            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="relative isolate overflow-hidden">
                    <div className="text-center mx-auto max-w-3xl">
                        ...
                        <h2 className="mt-6 text-4xl tracking-tight text-[#96d279] sm:text-5xl">
                            Join with us.
                        </h2>
                    ...
                    >
                        <div className="flex gap-x-3">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="min-w-0 flex-auto rounded-full bg-white px-3.5 py-2 text-black sm:text-base sm:leading-6"
                                placeholder="Enter your email"
                            />
                            <button
                                type="submit"
                                className="mx-auto max-w-md rounded-full bg-[#96d279] px-3.5 py-2.5 text-base tracking-wide text-black shadow-sm"
                            >
                                Subscribe
                            </button>
                        </div>
