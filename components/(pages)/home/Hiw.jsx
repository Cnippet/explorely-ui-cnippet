        ...
        <section className="relative z-20 bg-white py-24 font-swir sm:py-28">
            <div className="mx-auto max-w-full px-6 md:max-w-[85%] lg:px-8">
                <div className="mx-auto flex justify-between">
                    ...
                    <p className="mb-auto text-right font-swim text-2xl leading-8 text-gray-600">
                ...
                <div className="mx-auto mt-8 max-w-2xl sm:mt-20 lg:mt-12 lg:max-w-none">
                    <dl className="mx-auto grid max-w-xl grid-rows-1 gap-y-10 lg:max-w-none lg:grid-rows-3">
                        {features.map((feature) => (
                            <div
                                key={feature.id}
                                className="sticky top-36 flex flex-row gap-x-3 md:p-3"
                            >
                                <dt
                                    className={`my-auto flex h-full w-full flex-col justify-between gap-y-5 rounded-3xl  p-16 text-3xl ${feature.class}`}
                                >
                                    <Image src={feature.svg} alt="" className="h-16 w-16" />
                                ...
                                <dd className="w-full max-w-lg overflow-hidden rounded-3xl text-gray-500">
                                    <Image
                                        src={feature.image}
                                        alt="post-img"
                                        className="aspect-video h-full w-full transform object-cover duration-300 ease-in-out hover:scale-110"
                                    />
                                </dd>
                            </div>
                        ))}
