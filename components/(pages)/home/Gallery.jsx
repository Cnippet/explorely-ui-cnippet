...
import G1 from "@/public/p1.jpg";
import G2 from "@/public/p2.jpg";
import G3 from "@/public/p3.jpg";

const Gallery = () => {
    return (
        <section id="gallery" className="relative isolate py-8 font-swir lg:py-24">
            <div className="mx-auto max-w-full px-8 md:max-w-[85%]">
                <div className="relative flex flex-1 justify-start gap-4 overflow-visible p-0">
                    <div className="flex flex-col justify-between">
                        ...
                        <p className="w-[70%] text-lg text-gray-500 md:text-2xl">
