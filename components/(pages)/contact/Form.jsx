...
const Form = () => {
    return (
        <section className="relative isolate overflow-hidden font-swir">
            <div className="mx-auto grid max-w-[85%] grid-cols-1 py-20 lg:grid-cols-2">
                    ...
                    <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        {/* <dl className="mt-10 space-y-8 text-base text-gray-700">
                            ...
                            <div className="flex gap-6">
                                ...
                                <dd>
                                    <a href="mailto: ui@cnippet.com">ui@cnippet.com</a>
                                </dd>
                            </div>
                        </dl> */}
                    </div>
                ...
                <form className="form mx-auto my-auto max-w-xl space-y-8 px-4">
                    ...
                    <p className="text-base text-gray-700">
                        ...
                        <span className=" font-swim text-[#96d279]">
                    ...
                    <button
                        type="submit"
                        className="rounded-full bg-[#96d279] px-5 py-3 text-center text-base font-medium text-black sm:w-fit"
                    >
                        Send message
                    </button>
                </form>
